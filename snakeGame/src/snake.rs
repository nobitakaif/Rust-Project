...
impl Snake{
    pub fn new(x:i32, y:i32)->Snake{ // there is no &self args that means it is a static fn like -> Snake::new
        let mut body  = LinkedList::new(); // built-in Linkedlist which use struc of Body
